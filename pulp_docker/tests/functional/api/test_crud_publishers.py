...
from pulp_docker.tests.functional.constants import DOCKER_PUBLISHER_PATH
from pulp_docker.tests.functional.utils import gen_docker_publisher, skip_if
...
class CRUDPublishersTestCase(unittest.TestCase):
    ...
    def test_01_create_publisher(self):
        """Create a publisher."""
        body = gen_docker_publisher()
        type(self).publisher = self.client.post(DOCKER_PUBLISHER_PATH, body)
    ...
    def test_02_read_publishers(self):
        ...
        page = self.client.get(DOCKER_PUBLISHER_PATH, params={
