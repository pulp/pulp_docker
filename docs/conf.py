# -*- coding: utf-8 -*-
#
# Pulp Docker documentation build configuration file, created by
...
htmlhelp_basename = 'PulpDockerdoc'
...
latex_documents = [
  ('index', 'PulpDocker.tex', u'Pulp Docker Documentation',
   u'Pulp Team', 'manual'),
]
...
man_pages = [
    ('index', 'pulpdocker', u'Pulp Docker Documentation',
     [u'Pulp Team'], 1)
]
...
texinfo_documents = [
  ('index', 'PulpDocker', u'Pulp Docker Documentation',
   u'Pulp Team', 'PulpDocker', 'One line description of project.',
   'Miscellaneous'),
]
