...
class TestDockerManifest(unittest.TestCase):
    ...
    def test___init__(self):
        ...
        m = models.DockerManifest(name, tag, architecture, fs_layers, history, schema_version,
                                  signatures)
    ...
    def test___init___bad_schema(self):
        ...
        self.assertRaises(ValueError, models.DockerManifest, name, tag, architecture, fs_layers,
                          history, schema_version, signatures)
    ...
    def test_from_json(self):
        ...
        m = models.DockerManifest.from_json(manifest)
