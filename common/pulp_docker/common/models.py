...
class DockerManifest(object):
    ...
    def __init__(self, name, tag, architecture, fs_layers, history, schema_version, signatures):
        """
    ...
    @classmethod
    def from_json(cls, manifest_json):
        """
        ...
        return cls(
            ...
            fs_layers=manifest['fsLayers'], history=manifest['history'],
