...
pip install ansible
cp pulp_docker/.travis/playbook.yml ansible-pulp/playbook.yml
cp pulp_docker/.travis/postgres.yml ansible-pulp/postgres.yml
cp pulp_docker/.travis/mariadb.yml ansible-pulp/mariadb.yml
