...
- Blobs with manifest references should not be removed. (ipanova@redhat.com)
- Add docker command to point a tag to manifest (daviddavis@redhat.com)
- Adds release notes for 2.2.0 (dkliban@redhat.com)
- Automatic commit of package [pulp-docker] release [2.2.0-0.1.beta].
  (sean.myers@redhat.com)
- Bumping version to 2.2.0-0.1.beta (sean.myers@redhat.com)
- Bumping version to 2.3.0-0.1.alpha (sean.myers@redhat.com)
...
- Bumping version to 2.1.1-0.1.alpha (sean.myers@redhat.com)
